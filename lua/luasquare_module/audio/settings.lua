...
if not GetConVar('luasquare_audio_annunciator_volume') then
    CreateClientConVar('luasquare_audio_annunciator_volume', '1', true, true,
...
hook.Add('PopulateToolMenu', 'LUASQUARE_AUDIO_Settings', function()
    spawnmenu.AddToolMenuOption('Options', 'Luasquare', 'LuasquareAudio', 'Audio System', '', '', function(panel)
        ...
        panel:NumSlider('Annunciator volume', 'luasquare_audio_annunciator_volume', 0, 1, 2)
